...
public class SharpenedDrillInv {

    private Main plugin;
    public SharpenedDrillInv(Main plugin){
        this.plugin = plugin;
    }
    ...
    public static void initialize(){
        inventory_name = Utils.chat("&l&7Sharpened Drill");
        inv = Bukkit.createInventory(null, inv_rows);
    }

    public static Inventory SharpenedDrillInv(Player p) {
