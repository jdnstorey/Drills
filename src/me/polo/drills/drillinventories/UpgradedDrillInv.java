...
public class UpgradedDrillInv {

    private Main plugin;
    public UpgradedDrillInv(Main plugin){
        this.plugin = plugin;
    }
    ...
    public static void initialize(){
        inventory_name = Utils.chat("&l&7Upgraded Drill");
        inv = Bukkit.createInventory(null, inv_rows);
    }

    public static Inventory UpgradedDrillInv(Player p) {
